...
import devmax.drmmx.com.architecturecomponents.ui.addnote.AddEditNoteActivity;
import devmax.drmmx.com.architecturecomponents.viewmodel.NoteViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK) {
            ...
            Toast.makeText(this, "Note did not save", Toast.LENGTH_SHORT).show();
        }
    }
